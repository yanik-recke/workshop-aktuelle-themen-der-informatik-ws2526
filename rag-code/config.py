...
# === API Base URLs ===
# Both now use OpenAI API
OPENAI_EMBED_BASE_URL = os.getenv("OPENAI_EMBED_BASE_URL", "https://api.openai.com/v1")  # OpenAI API
OPENAI_CHAT_BASE_URL = os.getenv("OPENAI_CHAT_BASE_URL", "https://api.openai.com/v1")    # OpenAI API

# Old config for local Ollama:
# OPENAI_EMBED_BASE_URL = os.getenv("OPENAI_EMBED_BASE_URL", "http://localhost:11434/v1")  # Ollama

# WICHTIG: Setze diese Umgebungsvariable:
